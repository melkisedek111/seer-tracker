...
import { createPlateEditor, Plate, ParagraphPlugin, PlateElement, PlateLeaf, PlateStoreProvider, createPlateStore  } from '@udecode/plate-common/react';
...
export const editorPlateOptions = createPlateEditor({
    ...PlateJSOptions
});
...
const PageContainer = ({ children }: { children: ReactNode }) => {
    ...
    return <PlateStoreProvider editor={editorPlateOptions} id="plate-editor" >
        {children}
    </PlateStoreProvider>
}
